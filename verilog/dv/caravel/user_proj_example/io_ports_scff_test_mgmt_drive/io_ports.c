...
void main() {
  ...
  */
  ...
  reg_mprj_io_0 =  GPIO_MODE_MGMT_STD_BIDIRECTIONAL;   // Test_en
  reg_mprj_io_1 =  GPIO_MODE_MGMT_STD_BIDIRECTIONAL;   // IO_ISOL_N
  reg_mprj_io_2 =  GPIO_MODE_USER_STD_INPUT_NOPULL;    
  reg_mprj_io_3 =  GPIO_MODE_USER_STD_INPUT_NOPULL;    
  
  // Use to flag start and end of test
  ...
  reg_mprj_io_12 =  GPIO_MODE_MGMT_STD_BIDIRECTIONAL;   // ccff_head
  ...
  reg_mprj_io_25 =  GPIO_MODE_MGMT_STD_BIDIRECTIONAL;   // LA
  // To drive scan-chain head from the mgmt_soc
  ...
  /* TEST:  Recast channels 26 to allow input to user project	*/
