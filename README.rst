...
-  `Caravel Architecture <#caravel-architecture>`__
   ...
   -  `Management Area <#management-area>`__
   -  `User Project Area <#user-project-area>`__
   -  `Storage Area <#storage-area>`__
...
If you are building a digital project for the user space, 
